...
pub async fn run_ambient_command(cmd: AmbientSubcommand) -> Result<()> {
    match cmd {
        ...
        AmbientSubcommand::Log => {
            super::debug::run_debug_command("ambient:log", "", None, None, false).await
        }
        AmbientSubcommand::Trigger => {
            super::debug::run_debug_command("ambient:trigger", "", None, None, false).await
        }
