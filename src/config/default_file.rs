...
[compaction]
# Compaction mode: "reactive" (after token warning), "proactive" (before warning), or "semantic" (topic-based)
# Use "proactive" for long-running sessions to keep context fresh
mode = "proactive"
