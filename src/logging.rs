...
/// Log an info message with format arguments (avoids `&format!` overhead at call sites)
#[macro_export]
...
/// Log an error message with format arguments (avoids `&format!` overhead at call sites)
#[macro_export]
...
/// Log a warning message with format arguments (avoids `&format!` overhead at call sites)
#[macro_export]
...
/// Log a debug message with format arguments (avoids `&format!` overhead at call sites)
#[macro_export]
