...
pub(super) fn stroke_paths_bounds(paths: &[Vec<[f32; 2]>]) -> ([f32; 2], [f32; 2]) {
...
pub(super) fn stroke_paths_length(paths: &[Vec<[f32; 2]>]) -> f32 {
    paths
        .iter()
        .map(|path| {
            path.windows(2)
...
pub(super) fn transform_handwriting_point(
    point: [f32; 2],
    origin: [f32; 2],
    scale: f32,
) -> [f32; 2] {
...
pub(super) fn push_aurora_ribbon(
    vertices: &mut Vec<Vertex>,
    size: PhysicalSize<u32>,
    center_y: f32,
    height: f32,
