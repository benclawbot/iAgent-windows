...
pub struct AmbientConfig {
    ...
    pub visible: bool,
    /// Desktop writing monitor settings
    pub desktop_monitoring: AmbientDesktopMonitoringConfig,
    /// Suggestion generation settings
    pub desktop_suggestions: AmbientDesktopSuggestionsConfig,
    /// Proactive notification settings
    pub desktop_notifications: AmbientDesktopNotificationsConfig,
}
...
impl Default for AmbientConfig {
    fn default() -> Self {
        Self {
            ...
            visible: true,
            desktop_monitoring: AmbientDesktopMonitoringConfig::default(),
            desktop_suggestions: AmbientDesktopSuggestionsConfig::default(),
            desktop_notifications: AmbientDesktopNotificationsConfig::default(),
        }
    }
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(default)]
pub struct AmbientDesktopMonitoringConfig {
    pub enabled_apps: Vec<String>,
    pub disabled_apps: Vec<String>,
}

impl Default for AmbientDesktopMonitoringConfig {
    fn default() -> Self {
        Self {
            enabled_apps: vec![
                "outlook".to_string(),
...
impl Default for AmbientDesktopSuggestionsConfig {
    fn default() -> Self {
        Self {
            min_text_length: 50,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(default)]
pub struct AmbientDesktopNotificationsConfig {
    pub enabled: bool,
    pub importance_threshold: u8,
    pub check_interval_seconds: u64,
}

impl Default for AmbientDesktopNotificationsConfig {
    fn default() -> Self {
        Self {
            enabled: true,
