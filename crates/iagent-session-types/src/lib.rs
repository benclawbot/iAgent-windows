...
use iagent_message_types::{ContentBlock, Message, Role, ToolCall};
...
pub struct EnvSnapshot {
    ...
    pub provider: String,
    pub model: String,
    pub iagent_version: String,
    pub iagent_git_hash: Option<String>,
    pub iagent_git_dirty: Option<bool>,
    pub os: String,
    pub arch: String,
    pub pid: u32,
    pub is_selfdev: bool,
...
pub struct SessionSearchReport {
    ...
    pub scanned_iagent_sessions: usize,
    pub candidate_iagent_sessions: usize,
